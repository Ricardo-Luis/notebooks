...
ThreeColumn(md"`Compound.GEN.Ex4.jl`", md"[![](https://img.shields.io/badge/GitHub_URL-notebook-C09107)](https://github.com/Ricardo-Luis/notebooks/blob/main/ME2/Compound.GEN.Ex4.jl)", md"`Last update: 11·09·2023`")
...
# ╔═╡ b04e0cea-b570-4292-a31b-3b7fb1ed586e
...
begin
	...
	plot!([Id_], seriestype = :vline, ylims=(0,400),linestyle=:dashdot, 
			linewidth=2, linecolor=:red, label="Id_=$(Id_)A")
	...
	plot!([Id_], seriestype = :vline, ylims=(0,3000),linestyle=:dashdot, 
...
# ╔═╡ 058a7cec-e308-4b6f-a2a2-4a38f2df2b00
...
# ╔═╡ 86be9495-d669-4fe6-b2c4-a652d94deb77
md"""
...
# ╔═╡ 07647e8f-3d8b-4861-a278-8a2934992614
md"""
---
"""

# ╔═╡ d54b6352-c7cc-4d8c-bc9e-c7921215b73f
