...
#> [frontmatter]
#> URL = "https://github.com/Ricardo-Luis/notebooks/blob/main/ME2/EqualArea.jl"
#> title = "Critério da igualdade das áreas"
#> date = "2022-11-04"
#> tags = ["Critério da igualdade das áreas"]
#> description = "Análise de grandes perturbações da máquina síncrona trifásica"
...
ThreeColumn(md"`EqualArea.jl`", md"[![](https://img.shields.io/badge/GitHub_URL-notebook-C09107)](https://github.com/Ricardo-Luis/notebooks/blob/main/ME2/EqualArea.jl)", md"`Last update: 04·11·2022`")
...
**_Time to first plot_**: até cerca de 3.5 min.
