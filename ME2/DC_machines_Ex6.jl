...
# ╔═╡ 87594d45-fc57-4e45-9c8f-31f3482f6615
html"<button onclick='present()'>present</button>"

# ╔═╡ ea09eda3-1bae-48f1-aea7-60430df3061a
md"""
# Máquinas de corrente contínua (Ex. 6)
Geradores de corrente contínua, exercício 6:
"""
...
begin
	plot(I,U₁, markershape=:circle, markersize=3, linecolor=:blue, linewidth=0, title="U =f(I)", xlabel = "I(A)", ylabel="U(V)", ylims=(00,250), framestyle = :origin, minorticks=5, label="U₁=f(I₁)") # alterar o parâmetro "ylims" para a fazer zoom ao gráfico!
...
# ╔═╡ 5053fd53-5f56-4530-bc37-9b50a41df9ce
md"""
# Setup
"""

# ╔═╡ 91a43317-b954-4e6d-8dbc-693e2b02811b
TableOfContents(title="📚 Índice, Exercício 6")

# ╔═╡ 05381414-0387-416f-88a9-fde301422f47
md"""
!!! info
	No índice deste *notebook*, os tópicos assinalados com "💻" permitem interacção com o utilizador.
"""

# ╔═╡ a8ed52a1-275b-40cb-b870-6bc7fbcc12a4
md"""
## _Julia packages_
...
# ╔═╡ dee0d703-dc5e-40d0-a18f-d532d98811aa
md"""
!!! info
...
# ╔═╡ 8979d0d6-cc08-4c6f-bd43-6c78db1ea67c
version=VERSION;

# ╔═╡ 03847612-6c6f-4142-bd3c-2c1e31f911f2
md"""
## _Notebook_
...
# ╔═╡ 05f5e64f-96bb-4c32-bff8-25c8238d81d1
md"""
