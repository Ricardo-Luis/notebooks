...
# ╔═╡ 0b9abd74-d199-4720-803e-eb7861b86572
begin
...
# ╔═╡ d2a788ef-5292-4229-a1d1-3fd15db67c51
md"""
# Máquina síncrona trifásica  

## Motor síncrono de pólos salientes (Ex.8)
Máquinas síncronas trifásicas, exercício 8:
"""
...
A determinação do vector fcem efectiva, $$\overline{E'}$$, (cálculo intermédio de $$\overline{E'}_0$$) permite definir a posição espacial dos eixos directo (linha dos pólos) e de quadratura (posicão das fcem), uma vez que se obtém o ângulo de carga, $$\delta$$.
"""
...
**Determine a potências desenvolvidas (em pu) devido à fem de excitação e devido ao
...
# ╔═╡ 7f123aae-2f4d-4cf5-825f-7fe3a8f69c0c
md"""
...
begin
	...
	plot!([0,E_], arrow=:closed, minorticks=5, label="E'∠δ",
		linewidth=2, linecolor=:blue, ylims=(-0.75,0.75), 
		xlims=(-0.25,1.25), size=(600,600))
	...
	#E´₀:
	plot!([U_+_jXqI_,U_+_jXqI_-relut_], arrow=:closed,
		label="(Xd-Xq)Id∠(δ)", linewidth=2)
...
# ╔═╡ 54f98ff2-02ae-418f-8c87-0e31f70352a0
md"""
## Índice
"""
...
# ╔═╡ ea2e1c0e-241a-4c37-9420-3f882d78a47f
md"""
!!! info
...
# ╔═╡ 520bfd7b-ad1f-44a8-a1ee-503a22923adc
md"""
## _Julia packages_
*Links to package help*: [Plots](http://docs.juliaplots.org/latest/), [PlutoUI](https://juliahub.com/docs/PlutoUI/abXFp/0.7.6/)  
"""

# ╔═╡ cd9e2120-93fb-499a-8091-0dd6890d90e1
version=VERSION;

# ╔═╡ cd703dc2-6b7a-49b1-91e1-84ee712a7a9c
md"""
## _Notebook_
...
# ╔═╡ 021642cb-8edd-4349-833f-41ca4144ee58
md"""
