...
ThreeColumn(md"`Test.DCmachines.jl`", md"[![](https://img.shields.io/badge/GitHub_URL-notebook-C09107)](https://github.com/Ricardo-Luis/notebooks/blob/main/ME2/Test.DCmachines.jl)", md"`Last update: 11·09·2023`")
...
begin
	if z==false
		...
		**_Time to first plot_**: até cerca de 1.8 min.
		...
		**Time to first plot**: up to 1.8 min.
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "88822a49ac86c4fbd1712707ba7b0e66f1201e58"
