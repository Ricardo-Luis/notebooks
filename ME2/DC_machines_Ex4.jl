...
# ╔═╡ af807a43-e828-46e5-b50a-8da60591dec2
begin
...
# ╔═╡ a417311b-4195-46ad-b106-a8f82057d292
html"<button onclick='present()'>present</button>"

# ╔═╡ 2d599785-a7a3-4e46-8394-276c444c2749
md"""
# Máquinas de corrente contínua (Ex. 4)
Geradores de corrente contínua, exercício 4:
"""
...
md"""
## c) Influência de $$n$$ e $$R_c$$ em $$U=f(I)$$ 💻
...
md"""
!!! info
	No enunciado original é considerado interruptor ligado, o que corrresponde ao gerador de excitação derivação. Nesta versão propõe-se a análise com o interruptor desligado, consequentemente o gerador encontra-se ligado com excitação composta.  \
	Analise a trajetória do ponto de funcionamento (característica externa), actuando na "carga" (corrente). 
"""
...
# ╔═╡ 052779bc-3fb2-4482-83cd-e7113726e597


# ╔═╡ d3e64e5a-19ac-4858-b0d1-118e4fd40f16
md"""
# Setup
"""

# ╔═╡ a7f8c518-ea6c-4aab-b117-86fdbfba1414
TableOfContents(title="📚 Índice, Exercício 4")

# ╔═╡ 7c6183ee-93bc-4797-a92e-8c8c6f4be07c
md"""
!!! info
	No índice deste *notebook*, os tópicos assinalados com "💻" permitem interacção com o utilizador.
"""

# ╔═╡ 1984de4e-a917-441a-9617-bb5e6e4c69b8
md"""
## _Julia packages_
...
# ╔═╡ bf6ede73-b315-4d89-a39c-10190c83fbc3
md"""
!!! info
...
# ╔═╡ e618fc88-0095-46cb-a353-4098950a2f49
version=VERSION;

# ╔═╡ dbf9d2bc-a925-4649-94bd-2bf2a184fb6e
md"""
## _Notebook_
...
# ╔═╡ 91e58ccc-54a3-48f1-b70c-29a2cf0492aa
md"""
