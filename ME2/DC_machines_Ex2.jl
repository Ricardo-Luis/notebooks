...
# ╔═╡ 3bc2bef1-b886-4fd1-a248-9d70a5551275
html"<button onclick='present()'>present</button>"

# ╔═╡ 8c0dc890-8be4-11eb-020b-1f0a062e06e2
md"""
# Máquinas de corrente contínua (Ex. 2)
Geradores de corrente contínua, exercício 2:
"""
...
!!! nota
	...
	**Com base numa $$U =f(I)$$ pode-se obter uma família de características externas em função da corrente de campo e da velocidade de accionamento do gerador:**
"""
...
# ╔═╡ 342f3fc6-0dbb-4c0e-897b-4eb09153f996
begin
	H3=("Velocidade", @bind rpm PlutoUI.Slider(500:10:2000, default=1500, show_value=true))
	H3
end
...
# ╔═╡ a2a9e0e7-7c3d-40fb-af72-33faf1e6fb33
begin
	H2=("Iexc, corrente de excitação (exc. separada)", @bind Icampo PlutoUI.Slider(0:0.01:1.5, default=Id00, show_value=true))
	H2
end
...
begin
	Uspeed=E₀exx.-ΔUₜ
	P1=plot(I,Uspeed, title="U=f(I)", xlabel = "I(A)", ylabel="U(V)", ylims=(0,420), xlims=(0,20), label="U=f(I)")
	plot!(I, Rcarga*I, xlims=(0,20),ylims=(0,400), linestyle=:dash, label="Reta de Carga=$(Rcarga)Ω", legend=:best)
	plot!(I,ΔUₜ, label="ΔUₜ", linecolor=:black)
	plot!([E₀exx], seriestype = :hline, linecolor=:green, label="E₀=f(I) => constante, U₀=$(round(E₀exx))V", legend=:topleft)
	P2=plot(Iexc,E₀ₙ,title="E₀=f(Iₑₓ), n=$(rpm)rpm", xflip=false, ylims=(0,400), xlabel = "Iₑₓ(A)", ylabel="E₀(V)", xlims=(0,1.5), label=false)
	plot!([Icampo], seriestype = :vline, linecolor=:green,linestyle=:dash, xlims=(0,1.5),ylims=(0,400), label="ponto de excitação=$(Icampo)A", legend=:bottomright)
...
begin
	H4=("Rexc, resistência total do circuito de excitação derivação", @bind Rexc PlutoUI.Slider(300/1.5:1:Rcrítica, default=356, show_value=true)) #default=278/Id00
	H4
end
...
# ╔═╡ 7d00fd4c-7ff5-4702-92fc-15db87026c5c
md"""
!!! nota
	### Variação de  $$U =f(I)$$ com $$n$$ 💻
	**Observe o comportamento da característica externa do gerador derivação, $$U =f(I)$$, para diferentes valores de velocidade de accionamento, $$n$$ , e reóstato de campo constante, $$R_c=constante$$. \
...
# ╔═╡ f2ceacb5-51f3-46e6-a8f8-719a2e8cfc42
md"""
# Setup
"""

# ╔═╡ c2970a25-f58d-45d7-8187-cbf12d0c3a15
TableOfContents(title="📚 Índice, Exercício 2")

# ╔═╡ 43cbf32d-f2df-48f4-b454-5a7e7b011156
md"""
!!! info
	No índice deste *notebook*, os tópicos assinalados com "💻" permitem interacção com o utilizador.
"""

# ╔═╡ 71bb6235-34dd-4cb8-9354-6e2cf9c23932
md"""
## _Julia packages_
...
# ╔═╡ 1a40a9b8-8b7e-41e7-95f8-a3a21835dfe6
md"""
## _Notebook_
...
# ╔═╡ 30141ef2-bd2f-442a-80aa-62f352daedc5
md"""
